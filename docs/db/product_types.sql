...
-- ----------------------------
-- Indexes structure for table product_types
-- ----------------------------
CREATE INDEX "idx_product_types_name" ON "public"."product_types" USING btree (
  "name" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "idx_product_types_slug" ON "public"."product_types" USING btree (
...
-- ----------------------------
ALTER TABLE "public"."product_types" ADD CONSTRAINT "PK_product_types" PRIMARY KEY ("id");
