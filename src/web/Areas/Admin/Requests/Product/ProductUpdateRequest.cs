...
public class ProductUpdateRequest
{
    ...
    public List<ProductImageUpdateRequest> Images { get; set; } = new List<ProductImageUpdateRequest>();

    [Display(Name = "Thông tin bổ sung")]
    public List<ProductFieldValueUpdateRequest> CustomFields { get; set; } = new List<ProductFieldValueUpdateRequest>();
}