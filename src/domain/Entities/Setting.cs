    ...
    public void Configure(EntityTypeBuilder<Setting> builder)
    {
        ...
        builder.HasData(
            ...
            new Setting
            {
                ...
                Key = "ContactMapEmbed",
                Category = "Contact",
                Type = "HTML", // Cho phép nhúng mã HTML (iframe)
                Description = "Mã nhúng HTML của bản đồ (ví dụ: Google Maps iframe).",
                DefaultValue = null, // Để trống mặc định
                Value = null,
                IsActive = true,
            },
            new Setting
            ...
            new Setting { Id = 13, Key = "SocialFacebookUrl", Category = "Social Media", Type = "URL", Description = "URL trang Facebook.", DefaultValue = null, Value = null, IsActive = true },
            new Setting { Id = 14, Key = "SocialTwitterUrl", Category = "Social Media", Type = "URL", Description = "URL trang Twitter (X).", DefaultValue = null, Value = null, IsActive = true },
            new Setting { Id = 15, Key = "SocialInstagramUrl", Category = "Social Media", Type = "URL", Description = "URL trang Instagram.", DefaultValue = null, Value = null, IsActive = true },
            new Setting { Id = 16, Key = "SocialLinkedInUrl", Category = "Social Media", Type = "URL", Description = "URL trang LinkedIn.", DefaultValue = null, Value = null, IsActive = true },
            new Setting { Id = 17, Key = "SocialYoutubeUrl", Category = "Social Media", Type = "URL", Description = "URL kênh Youtube.", DefaultValue = null, Value = null, IsActive = true },
            new Setting { Id = 18, Key = "SmtpHost", Category = "Email", Type = "Text", Description = "Địa chỉ máy chủ SMTP.", DefaultValue = "smtp.example.com", Value = "smtp.example.com", IsActive = true },
            new Setting { Id = 19, Key = "SmtpPort", Category = "Email", Type = "Number", Description = "Cổng SMTP (ví dụ: 587, 465, 25).", DefaultValue = "587", Value = "587", IsActive = true },
            new Setting { Id = 20, Key = "SmtpUsername", Category = "Email", Type = "Text", Description = "Tên đăng nhập SMTP.", DefaultValue = "user@example.com", Value = "user@example.com", IsActive = true },
            new Setting { Id = 21, Key = "SmtpPassword", Category = "Email", Type = "Password", Description = "**QUAN TRỌNG**: Mật khẩu SMTP. Nên cấu hình qua UI, không seed giá trị thật.", DefaultValue = null, Value = null, IsActive = true }, // !!! IMPORTANT !!!
            new Setting { Id = 22, Key = "SmtpUseSsl", Category = "Email", Type = "Boolean", Description = "Sử dụng mã hóa SSL/TLS khi gửi email.", DefaultValue = "true", Value = "true", IsActive = true },
            new Setting { Id = 23, Key = "EmailFromName", Category = "Email", Type = "Text", Description = "Tên hiển thị trong ô 'From' của email gửi đi.", DefaultValue = "My Application Support", Value = "My Application Support", IsActive = true },
            new Setting { Id = 24, Key = "EmailFromAddress", Category = "Email", Type = "Email", Description = "Địa chỉ email hiển thị trong ô 'From' của email gửi đi.", DefaultValue = "noreply@example.com", Value = "noreply@example.com", IsActive = true }
        );
    }
}