...
public class TagSeeder : ISeeder<Tag>
{
    public IEnumerable<Tag> DataSeeder()
    {
        ...
        [
            ...
            new Tag{ Id = 101, Name = "Thi công nhanh chóng", Slug = "thi-cong-nhanh-chong", EntityType = EntityType.Content },
            new Tag{ Id = 102, Name = "Thợ sơn tay nghề cao", Slug = "tho-son-tay-nghe-cao", EntityType = EntityType.Content },
            new Tag{ Id = 103, Name = "Bảo hành dài hạn", Slug = "bao-hanh-dai-han", EntityType = EntityType.Content },
            new Tag{ Id = 104, Name = "Tư vấn màu sắc miễn phí", Slug = "tu-van-mau-sac-mien-phi", EntityType = EntityType.Content },
            new Tag{ Id = 105, Name = "Báo giá cạnh tranh", Slug = "bao-gia-canh-tranh", EntityType = EntityType.Content },
            new Tag{ Id = 106, Name = "Thi công sơn nội thất", Slug = "thi-cong-son-noi-that", EntityType = EntityType.Content },
            new Tag{ Id = 107, Name = "Thi công sơn ngoại thất", Slug = "thi-cong-son-ngoai-that", EntityType = EntityType.Content },
            new Tag{ Id = 108, Name = "Tư vấn kỹ thuật chuyên nghiệp", Slug = "tu-van-ky-thuat-chuyen-nghiep", EntityType = EntityType.Content },
            new Tag{ Id = 109, Name = "Thi công sơn trọn gói", Slug = "thi-cong-son-tron-goi", EntityType = EntityType.Content },
            new Tag{ Id = 110, Name = "Tư vấn lựa chọn sơn", Slug = "tu-van-lua-chon-son", EntityType = EntityType.Content },
            new Tag{ Id = 111, Name = "Đảm bảo chất lượng thi công", Slug = "dam-bao-chat-luong-thi-cong", EntityType = EntityType.Content },
            new Tag{ Id = 112, Name = "Hỗ trợ tận tâm", Slug = "ho-tro-tan-tam", EntityType = EntityType.Content },        ];
    }
}