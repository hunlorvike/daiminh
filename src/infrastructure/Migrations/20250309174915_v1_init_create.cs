    ...
    public partial class v1_init_create : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 3, 9, 17, 49, 15, 378, DateTimeKind.Utc).AddTicks(1610), null, true, "Admin", "", new DateTime(2025, 3, 9, 17, 49, 15, 378, DateTimeKind.Utc).AddTicks(1613) },
                    { 2, new DateTime(2025, 3, 9, 17, 49, 15, 378, DateTimeKind.Utc).AddTicks(1615), null, true, "User", "", new DateTime(2025, 3, 9, 17, 49, 15, 378, DateTimeKind.Utc).AddTicks(1620) },
                    { 3, new DateTime(2025, 3, 9, 17, 49, 15, 378, DateTimeKind.Utc).AddTicks(1621), null, true, "Manager", "", new DateTime(2025, 3, 9, 17, 49, 15, 378, DateTimeKind.Utc).AddTicks(1621) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 3, 9, 17, 49, 14, 990, DateTimeKind.Utc).AddTicks(5012), null, "admin@admin.com", true, "$2a$11$xPyAqsgv8RCO72cbRragQuyskW0yuPgorfpl4Nrw1.MHU3eT5YlXW", 1, new DateTime(2025, 3, 9, 17, 49, 14, 990, DateTimeKind.Utc).AddTicks(5085), "admin" },
                    { 2, new DateTime(2025, 3, 9, 17, 49, 15, 119, DateTimeKind.Utc).AddTicks(8474), null, "user@user.com", true, "$2a$11$v8qL4XQTpJKKh.zvXbBT8.ty3k0rkMpxR.Yt9aUQPobuPz1WSEtYa", 2, new DateTime(2025, 3, 9, 17, 49, 15, 119, DateTimeKind.Utc).AddTicks(8477), "user" },
                    { 3, new DateTime(2025, 3, 9, 17, 49, 15, 250, DateTimeKind.Utc).AddTicks(3574), null, "manager@manager.com", true, "$2a$11$6Nr2y/BvIyMIr.YGeZ.c5etdvjqOYi4uBbHoX4PH89Nhn0y.JTc/6", 3, new DateTime(2025, 3, 9, 17, 49, 15, 250, DateTimeKind.Utc).AddTicks(3575), "manager" }
                });
