    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                packaging_info = table.Column<string>(type: "nvarchar(max)", nullable: true),
                storage_instructions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                safety_info = table.Column<string>(type: "nvarchar(max)", nullable: true),
                application_areas = table.Column<string>(type: "nvarchar(max)", nullable: true),
                technical_documents = table.Column<string>(type: "nvarchar(max)", nullable: true),
                view_count = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                is_featured = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                is_active = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                status = table.Column<int>(type: "int", maxLength: 20, nullable: false, defaultValue: 0),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                media_type = table.Column<int>(type: "int", maxLength: 20, nullable: false, defaultValue: 0),
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[] { 1, "General", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8058), null, "Đại Minh Việt Nam", "Tên website hiển thị trên trang và tiêu đề trình duyệt.", true, "SiteName", null, null, "Đại Minh Việt Nam" });
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 2, "General", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8066), null, "https://localhost:7001", "Địa chỉ URL chính của website (ví dụ: https://www.example.com).", true, "SiteUrl", 7, null, null, "https://localhost:7001" },
                { 3, "General", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8067), null, "sondaiminh@gmail.com", "Địa chỉ email quản trị viên để nhận thông báo hệ thống.", true, "AdminEmail", 6, null, null, "sondaiminh@gmail.com" }
            });

        migrationBuilder.InsertData(
            table: "settings",
            columns: new[] { "Id", "category", "created_at", "created_by", "default_value", "description", "is_active", "key", "updated_at", "updated_by", "value" },
            values: new object[] { 5, "Contact", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8069), null, "Đại Minh Việt Nam", "Tên công ty hoặc tổ chức sở hữu website.", true, "CompanyName", null, null, "Đại Minh Việt Nam" });
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 6, "Contact", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8070), null, "123 Main Street, Anytown, CA 91234", "Địa chỉ liên hệ đầy đủ.", true, "ContactAddress", 1, null, null, "123 Main Street, Anytown, CA 91234" },
                { 7, "Contact", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8071), null, "(123) 456-7890", "Số điện thoại liên hệ chính.", true, "ContactPhone", 4, null, null, "(123) 456-7890" },
                { 8, "Contact", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8072), null, "contact@example.com", "Địa chỉ email hiển thị công khai để liên hệ.", true, "ContactEmail", 6, null, null, "contact@example.com" },
                { 9, "Contact", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8073), null, null, "Mã nhúng HTML của bản đồ (ví dụ: Google Maps iframe).", true, "ContactMapEmbed", 2, null, null, null }
            });

        migrationBuilder.InsertData(
            table: "settings",
            columns: new[] { "Id", "category", "created_at", "created_by", "default_value", "description", "is_active", "key", "updated_at", "updated_by", "value" },
            values: new object[] { 10, "SEO", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8075), null, "Welcome to My Application", "Tiêu đề meta mặc định cho các trang không có tiêu đề riêng.", true, "DefaultMetaTitle", null, null, "Welcome to My Application" });
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 11, "SEO", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8077), null, "This is the default description for My Application.", "Mô tả meta mặc định (dưới 160 ký tự).", true, "DefaultMetaDescription", 1, null, null, "This is the default description for My Application." },
                { 12, "SEO", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8079), null, "/image/icon.jpg", "Đường dẫn đến file favicon.ico hoặc ảnh favicon.", true, "FaviconUrl", 3, null, null, "/image/icon.jpg" },
                { 13, "Social Media", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8080), null, null, "URL trang Facebook.", true, "SocialFacebookUrl", 7, null, null, null },
                { 14, "Social Media", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8081), null, null, "URL trang Twitter (X).", true, "SocialTwitterUrl", 7, null, null, null },
                { 15, "Social Media", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8082), null, null, "URL trang Instagram.", true, "SocialInstagramUrl", 7, null, null, null },
                { 16, "Social Media", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8083), null, null, "URL trang LinkedIn.", true, "SocialLinkedInUrl", 7, null, null, null },
                { 17, "Social Media", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8085), null, null, "URL kênh Youtube.", true, "SocialYoutubeUrl", 7, null, null, null }
            });

        migrationBuilder.InsertData(
            table: "settings",
            columns: new[] { "Id", "category", "created_at", "created_by", "default_value", "description", "is_active", "key", "updated_at", "updated_by", "value" },
            values: new object[] { 18, "Email", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8086), null, "smtp.example.com", "Địa chỉ máy chủ SMTP.", true, "SmtpHost", null, null, "smtp.example.com" });

        migrationBuilder.InsertData(
            table: "settings",
            columns: new[] { "Id", "category", "created_at", "created_by", "default_value", "description", "is_active", "key", "type", "updated_at", "updated_by", "value" },
            values: new object[] { 19, "Email", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8087), null, "587", "Cổng SMTP (ví dụ: 587, 465, 25).", true, "SmtpPort", 8, null, null, "587" });
        ...
        migrationBuilder.InsertData(
            ...
            values: new object[,]
            {
                { 20, "Email", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8088), null, "user@example.com", "Tên đăng nhập SMTP.", true, "SmtpUsername", null, null, "user@example.com" },
                { 21, "Email", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8089), null, null, "**QUAN TRỌNG**: Mật khẩu SMTP. Nên cấu hình qua UI, không seed giá trị thật.", true, "SmtpPassword", null, null, null }
            });

        migrationBuilder.InsertData(
            table: "settings",
            columns: new[] { "Id", "category", "created_at", "created_by", "default_value", "description", "is_active", "key", "type", "updated_at", "updated_by", "value" },
            values: new object[] { 22, "Email", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8091), null, "true", "Sử dụng mã hóa SSL/TLS khi gửi email.", true, "SmtpUseSsl", 9, null, null, "true" });

        migrationBuilder.InsertData(
            table: "settings",
            columns: new[] { "Id", "category", "created_at", "created_by", "default_value", "description", "is_active", "key", "updated_at", "updated_by", "value" },
            values: new object[] { 23, "Email", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8092), null, "My Application Support", "Tên hiển thị trong ô 'From' của email gửi đi.", true, "EmailFromName", null, null, "My Application Support" });

        migrationBuilder.InsertData(
            table: "settings",
            columns: new[] { "Id", "category", "created_at", "created_by", "default_value", "description", "is_active", "key", "type", "updated_at", "updated_by", "value" },
            values: new object[] { 24, "Email", new DateTime(2025, 4, 21, 16, 39, 2, 6, DateTimeKind.Utc).AddTicks(8093), null, "noreply@example.com", "Địa chỉ email hiển thị trong ô 'From' của email gửi đi.", true, "EmailFromAddress", 6, null, null, "noreply@example.com" });

        migrationBuilder.InsertData(
            table: "users",
            columns: new[] { "Id", "created_at", "created_by", "email", "full_name", "is_active", "password_hash", "updated_at", "updated_by", "username" },
            values: new object[] { 1, new DateTime(2025, 4, 21, 16, 39, 2, 8, DateTimeKind.Utc).AddTicks(3520), null, "admin@admin.com", "Quản trị viên", true, "AQAAAAIAAYagAAAAEB7Al9vXqnmle/9WvVuHhQFguAz5j5e9cbb2H2QK3DAOc6f59KmrLIQzPkc/gpTxww==", null, null, "admin" });
