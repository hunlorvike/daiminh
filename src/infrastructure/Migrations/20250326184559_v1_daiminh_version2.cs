...
{
    /// <inheritdoc />
    public partial class v1_daiminh_version2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    type = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "permanent"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    entity_title = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    ...
                    ctr = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: false, defaultValue: 0.0),
                    average_position = table.Column<double>(type: "double precision", precision: 5, scale: 2, nullable: false, defaultValue: 0.0),
                    top_keywords = table.Column<string>(type: "json", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_seo_analytics", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_product_field_values_product_field_definitions_field_defini~",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_product_field_definitions_is_active",
                table: "product_field_definitions",
                column: "is_active");

            migrationBuilder.CreateIndex(
                name: "idx_product_field_definitions_is_filterable",
                table: "product_field_definitions",
                column: "is_filterable");

            migrationBuilder.CreateIndex(
                name: "idx_product_field_definitions_order_index",
                table: "product_field_definitions",
                column: "order_index");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_product_field_definitions_type_key",
                table: "product_field_definitions",
                columns: new[] { "product_type_id", "key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "idx_product_field_values_field_definition_id",
                table: "product_field_values",
                column: "field_definition_id");

            migrationBuilder.CreateIndex(
                name: "idx_product_field_values_product_field",
                table: "product_field_values",
                columns: new[] { "product_id", "field_definition_id" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "idx_redirects_is_active",
                table: "redirects",
                column: "is_active");

            migrationBuilder.CreateIndex(
                name: "idx_redirects_source_url",
                table: "redirects",
                column: "source_url");

            migrationBuilder.CreateIndex(
                name: "idx_seo_analytics_date",
                table: "seo_analytics",
                column: "date");

            migrationBuilder.CreateIndex(
                name: "idx_seo_analytics_entity_date",
                table: "seo_analytics",
                columns: new[] { "entity_type", "entity_id", "date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "idx_seo_analytics_entity_type",
                table: "seo_analytics",
                column: "entity_type");

            migrationBuilder.CreateIndex(
                name: "idx_seo_settings_is_active",
                table: "seo_settings",
                column: "is_active");

            migrationBuilder.CreateIndex(
                name: "idx_seo_settings_key",
                table: "seo_settings",
                column: "key",
                unique: true);
